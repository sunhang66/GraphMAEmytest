...
#             "feature_dim","feature_dim_num","mask_rate","encode_network","decode_network","norm",
#             "num_hidden","num_layers","activation","max_epoch","lr","first_result","second_result"]
#"dataset_name":("151507","151508","151509","151510","151669","151670","151671","151672","151673","151674","151675","151676"),
parameters = {
    "dataset_name":("151673",),
    "graph_devise":("CCST",),
    "threshold_num":(8,),
    ...
    "feature_dim_num" : (600,),
    "mask_rate" : (0.5,),
    "code_networt_and_norm" : (["gat","dotgat",None],),
    "num_hidden" : (128,),
    "num_layers" : (3,),
    "activation" : ("relu",),
    "max_epoch" : (500,),
...
for choose_parameter in parameters_list:
    ...
    args.decoder= choose_parameter["code_networt_and_norm"][1]
    args.norm = choose_parameter["code_networt_and_norm"][2]
    ...
    #print(time % 100 == 1)
    drawPicture(adata.obs,"imagecol","imagerow",colorattribute="lay_num",save_file= result_file + "/" + sample_name + "_DLPFC_lay_num_410.pdf",is_save=True,is_show=False)
    drawPicture(adata.obs,"imagecol","imagerow",colorattribute="pre",save_file= result_file + "/" + sample_name + "_DLPFC_pre_410.pdf",is_save=True,is_show=False)
    drawPicture(adata.obs,"imagecol","imagerow",colorattribute="second_pre",save_file= result_file + "/" + sample_name + "_DLPFC_second_pre_410.pdf",is_save=True,is_show=False)
in_result_file = result_file + "/all_result_en_de_760.csv"
